			...
			<div class="category-content no-padding">
				<ul class="navigation navigation-main navigation-accordion">
					...
					<?php if ($role_id == 1) : ?>
						...
						<li>
							<a href="#"><i class="icon-question3"></i> <span>Divine Category</span></a>
							<ul>
								<li <?php echo ($this->router->class == "divine" && $this->router->method == "add") ? 'class="active"' : ''; ?>><a href="<?php echo base_url('admin/divine/add'); ?>">Add</a></li>
								<li <?php echo ($this->router->class == "divine" && $this->router->method == "all") ? 'class="active"' : ''; ?>><a href="<?php echo base_url('admin/divine/all'); ?>">List</a></li>

							</ul>
						</li>

						<li>
							<a href="#"><i class="icon-stack2"></i> <span>Divine Pages</span></a>
							<ul>
